                ...
                <div className= "col-md-7">
                    ...
                    <Card className= "doctor-info">
                        <Card.Body>
                            ...
                            {/* the logic needs some modification */}
                            {props.provider.map((provider) => (provider.id == id)? (provider.provider_data.certificate_url !== null ? <div key= {provider.id}>
