...
const SingleArticleContainer = ({
                                    ...
                                    leaveComment, articles,
                                    setSingleArticle
                                }) => {

    const {id} = match.params;
    const cached_article = articles.find(article => (article.id = id))

    useEffect(() => {
        if (cached_article) {
            setSingleArticle(cached_article)
        } else {
            getSingleArticle(id);
        }
    }, [cached_article, setSingleArticle, getSingleArticle, id]);
    ...
    return (
        <div className="row container mx-auto mt-5 pb-5">
            ...
            <div className="col-md-9 px-4">
                ...
                <h5 className="my-4 font-weight-bold">{
                    stateData.loading === true ? 0 : stateData.model.comments_count} Comments</h5>
