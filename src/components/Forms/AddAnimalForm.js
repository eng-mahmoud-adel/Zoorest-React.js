            ...
            <div className="form-group add-animal-form col-10">
                ...
                <div className={props.stepOne}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-3 offset-1 mt-5">
                            <Button text="Back" color="btn btn-secondary" size="btn-sm"/>
                        </div>
                        <div className="col-3 mt-5">
                            <Button text="Next" color="btn btn-info" size="btn-sm"/>
                        </div>
                    </div>
                </div>}
                ...
                <div className={props.stepTwo}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-3 offset-1 mt-5">
                            <Button text="Back" color="btn btn-danger" size="btn-sm"/>
                        </div>
                        <div className="col-3 mt-5">
                            <Button text="Next" color="btn btn-info" size="btn-sm"/>
                        </div>
                ...
                <div className={props.stepThree}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-3 mt-5">
                            <Button text="Finish" color="btn btn-info" size="btn-sm"/>
                        </div>
                    </div>
                </div>}
            </div>
